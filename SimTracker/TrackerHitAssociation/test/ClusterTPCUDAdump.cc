...
ClusterTPCUDAdump::ClusterTPCUDAdump(const edm::ParameterSet& iConfig) :
...
void
ClusterTPCUDAdump::analyze(edm::StreamID streamID, edm::Event const & iEvent, const edm::EventSetup& iSetup) const {
 if (m_onGPU) {
...
void
ClusterTPCUDAdump::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
